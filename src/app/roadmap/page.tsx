...
import { CheckCircle2, ArrowRight, Rocket, AlertCircle, Sparkles, MessageCircle, Target } from 'lucide-react'
...
function RoadmapContent() {
  ...
  useEffect(() => {
    ...
    // Try loading cached roadmap first
    ...
    // Fall back to sessionStorage answers
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="bg-primary/5 border border-primary/10 rounded-[2rem] p-6 mb-6">
          <h2 className="font-bold text-dark mb-4 font-sans">Key insights</h2>
        ...
        {/* Full roadmap — now free for everyone */}
        <div className="space-y-6">
          ...
          <div className="bg-dark rounded-[2rem] p-8 text-background text-center relative overflow-hidden" id="share-card">
            <div className="relative z-10">
              ...
              <p className="text-background/40 text-xs mt-2 font-mono uppercase tracking-widest">HustlUp &mdash; AI-powered side hustle coach</p>
            </div>
          </div>
